...
class Nilbog(GlobalCreatureBaseClass):
    """
    Nilbog creature
    Size: Small, Type: Fey (Goblinoid), typically Chaotic Neutral
    ...
    DEFAULT_STATS = {
        ...
        "legendary": False,
        "size": "Small",
        "type": "Fey (Goblinoid), typically Chaotic Neutral",
        "hit_points_up": [1, 1, 1],
        "STR_up": [1, 0, 0],
        "DEX_up": [1, 0, 0],
        "CON_up": [0, 1, 0],
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.abilities.extend(['nilbogism'])

    def nilbogism(self) -> str:
        """Nilbogism: Any creature that attempts to damage the nilbog must first succeed on a DC 12 Charisma saving throw ..."""

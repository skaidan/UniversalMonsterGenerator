...
class GiantOwl(GlobalCreatureBaseClass):
    """
    Large beast creature - GiantOwl
    Source: AiDeDd Monster Database (D&D 5e SRD)
    """
    
    # Valores por defecto extraídos del scraping
    DEFAULT_STATS = {'hit_points': 19, 'min_level': 1, 'level': 1, 'STR': 13, 'DEX': 15, 'CON': 12, 'INT': 8, 'WIS': 13, 'CHAR': 10, 'armor_class': 12, 'alignment': 'neutral Armor Class  12 Hit Points  19 (3d10 + 3) Speed  5 ft.', 'legendary': False, 'size': 'Large', 'type': 'beast', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['flyby', 'talons']}
    ...
    def talons_attack(self) -> str:
        ...
        return 'Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 8 (2d6 + 1) slashing damage.'

# bases1/adult-bronze-dragon.py
"""
AdultBronzeDragon creature class scraped from https://www.aidedd.org/dnd/monstres.php?vo=adult-bronze-dragon
"""
from creature_base import GlobalCreatureBaseClass


class AdultBronzeDragon(GlobalCreatureBaseClass):
    """
    Huge dragon (Metallic) creature - AdultBronzeDragon
    Source: AiDeDd Monster Database (D&D 5e SRD)
    """
    
    # Valores por defecto extraídos del scraping
    DEFAULT_STATS = {'hit_points': 212, 'min_level': 1, 'level': 1, 'STR': 25, 'DEX': 10, 'CON': 23, 'INT': 16, 'WIS': 15, 'CHAR': 19, 'armor_class': 19, 'alignment': 'lawful good Armor Class  19 (natural armor) Hit Points  212 (17d12 + 102) Speed  40 ft.', 'legendary': False, 'size': 'Huge', 'type': 'dragon (Metallic)', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['amphibious', 'multiattack', 'bite', 'claw', 'tail', 'frightful_presence', 'breath_weapons_(recharge_5-6)', 'lightning_breath', 'repulsion_breath', 'change_shape']}
    ...
    def bite_attack(self) -> str:
        ...
        return 'Melee Weapon Attack: +12 to hit, reach 10 ft., one target. Hit: 18 (2d10 + 7) piercing damage.'

    def claw_attack(self) -> str:
        """Melee Weapon Attack: +12 to hit, reach 5 ft., one target. Hit: 14 (2d6 + 7) slashing damage."""
        return 'Melee Weapon Attack: +12 to hit, reach 5 ft., one target. Hit: 14 (2d6 + 7) slashing damage.'

    def tail_attack(self) -> str:
        """Melee Weapon Attack: +12 to hit, reach 15 ft., one target. Hit: 16 (2d8 + 7) bludgeoning damage."""
        return 'Melee Weapon Attack: +12 to hit, reach 15 ft., one target. Hit: 16 (2d8 + 7) bludgeoning damage.'
    ...
    def lightning_breath_attack(self) -> str:
        ...
        return 'The dragon exhales lightning in a 90-foot line that is 5 feet wide. Each creature in that line must make a DC 19 Dexterity saving throw, taking 66 (12d10) lightning damage on a failed save, or half as much damage on a successful one.'
    ...
    def repulsion_breath_attack(self) -> str:
        ...
        return 'The dragon exhales repulsion energy in a 30-foot cone. Each creature in that area must succeed on a DC 19 Strength saving throw. On a failed save, the creature is pushed 60 feet away from the dragon.'

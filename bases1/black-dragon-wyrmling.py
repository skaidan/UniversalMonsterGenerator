...
class BlackDragonWyrmling(GlobalCreatureBaseClass):
    ...
    def amphibious(self) -> str:
        ...
        return "The dragon can breathe air and water.ActionsBite. Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (1d10 + 2) piercing damage plus 2 (1d4) acid damage.Acid Breath (Recharge 5–6). The dr"
    def amphibious(self) -> str:
        """Amphibious: The dragon can breathe air and water.ActionsBite. Melee Weapon Attack: +4 to hit, reach 5 ft., one t..."""
        return "The dragon can breathe air and water.ActionsBite. Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (1d10 + 2) piercing damage plus 2 (1d4) acid damage.Acid Breath (Recharge 5–6). The dr"

...
class Weasel(GlobalCreatureBaseClass):
    ...
    def keen_hearing_and_smell(self) -> str:
        ...
        return "The weasel has advantage on Wisdom (Perception) checks that rely on hearing or smell.ActionsBite. Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 1 piercing damage.Monster Manual (SRD)
	"
    def keen_hearing_and_smell(self) -> str:
        """Keen Hearing and Smell: The weasel has advantage on Wisdom (Perception) checks that rely on hearing or smell.ActionsBite. Me..."""
        return "The weasel has advantage on Wisdom (Perception) checks that rely on hearing or smell.ActionsBite. Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 1 piercing damage.Monster Manual (SRD)

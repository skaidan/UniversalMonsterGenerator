# bases1/adult-red-dragon.py
"""
AdultRedDragon creature class scraped from https://www.aidedd.org/dnd/monstres.php?vo=adult-red-dragon
"""
from creature_base import GlobalCreatureBaseClass


class AdultRedDragon(GlobalCreatureBaseClass):
    """
    Huge dragon (Chromatic) creature - AdultRedDragon
    Source: AiDeDd Monster Database (D&D 5e SRD)
    """
    
    # Valores por defecto extraídos del scraping
    DEFAULT_STATS = {'hit_points': 256, 'min_level': 1, 'level': 1, 'STR': 27, 'DEX': 10, 'CON': 25, 'INT': 16, 'WIS': 13, 'CHAR': 21, 'armor_class': 19, 'alignment': 'chaotic evil Armor Class  19 (natural armor) Hit Points  256 (19d12 + 133) Speed  40 ft.', 'legendary': False, 'size': 'Huge', 'type': 'dragon (Chromatic)', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['legendary_resistance_(3/day)', 'multiattack', 'bite', 'claw', 'tail', 'frightful_presence', 'fire_breath_(recharge_5-6)']}
    ...
    def bite_attack(self) -> str:
        ...
        return 'Melee Weapon Attack: +14 to hit, reach 10 ft., one target. Hit: 19 (2d10 + 8) piercing damage plus 7 (2d6) fire damage.'
    ...
    def fire_breath_(recharge_5-6)_attack(self) -> str:
        ...
        return 'The dragon exhales fire in a 60-foot cone. Each creature in that area must make a DC 21 Dexterity saving throw, taking 63 (18d6) fire damage on a failed save, or half as much damage on a successful one.'

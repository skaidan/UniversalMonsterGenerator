...
class Gauth(GlobalCreatureBaseClass):
    ...
    DEFAULT_STATS = {'hit_points': 52, 'min_level': 1, 'level': 1, 'STR': 10, 'DEX': 14, 'CON': 16, 'INT': 15, 'WIS': 15, 'CHAR': 13, 'armor_class': 15, 'alignment': 'typically Lawful Evil Armor Class  15 (natural armor) Hit Points  52 (7d8 + 21) Speed  0 ft.', 'legendary': False, 'size': 'Medium', 'type': 'Aberration (Beholder)', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['death_throes', 'bite', 'eye_rays', 'ability_1__devour_magic_ray', 'ability_2__enervation_ray', 'ability_3__fire_ray', 'ability_4__paralyzing_ray', 'ability_5__pushing_ray', 'ability_6__sleep_ray']}
    ...
    def attack_1_devour_magic_ray_attack(self) -> str:
    ...
    def attack_2_enervation_ray_attack(self) -> str:
    ...
    def attack_3_fire_ray_attack(self) -> str:
    ...
    def attack_4_paralyzing_ray_attack(self) -> str:
    ...
    def attack_5_pushing_ray_attack(self) -> str:
    ...
    def attack_6_sleep_ray_attack(self) -> str:

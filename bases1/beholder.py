...
class Beholder(GlobalCreatureBaseClass):
    ...
    DEFAULT_STATS = {'hit_points': 180, 'min_level': 1, 'level': 1, 'STR': 10, 'DEX': 14, 'CON': 18, 'INT': 17, 'WIS': 15, 'CHAR': 17, 'armor_class': 18, 'alignment': 'lawful evil Armor Class  18 (natural armor) Hit Points  180 (19d10 + 76) Speed  0 ft.', 'legendary': False, 'size': 'Large', 'type': 'aberration', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['antimagic_cone', 'bite', 'eye_rays', 'ability_1__charm_ray', 'ability_2__paralyzing_ray', 'ability_3__fear_ray', 'ability_4__slowing_ray', 'ability_5__enervation_ray', 'ability_6__telekinetic_ray', 'ability_7__sleep_ray', 'ability_8__petrification_ray', 'ability_9__disintegration_ray', 'ability_10__death_ray']}

...
class ChromaticGreatwyrm(GlobalCreatureBaseClass):
    """
    ChromaticGreatwyrm creature
    Size: Gargantuan, Type: Dragon (Chromatic), typically Chaotic Evil
    ...
    DEFAULT_STATS = {
        ...
        "legendary": False,
        "size": "Gargantuan",
        "type": "Dragon (Chromatic), typically Chaotic Evil",
        "hit_points_up": [53, 53, 53],
        "STR_up": [1, 0, 0],
        "DEX_up": [1, 0, 0],
        "CON_up": [0, 1, 0],
        "INT_up": [0, 1, 0],

...
class HornedDevil(GlobalCreatureBaseClass):
    ...
    def devils_sight(self) -> str:
        ...
        return "Magical darkness doesn't impede the devil's darkvision.Magic Resistance. The devil has advantage on saving throws against spells and other magical effects.ActionsMultiattack. The devil makes three mel"
    def devils_sight(self) -> str:
        """Devil's Sight: Magical darkness doesn't impede the devil's darkvision.Magic Resistance. The devil has advantage on ..."""
        return "Magical darkness doesn't impede the devil's darkvision.Magic Resistance. The devil has advantage on saving throws against spells and other magical effects.ActionsMultiattack. The devil makes three mel"

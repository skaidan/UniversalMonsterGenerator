...
class Spectator(GlobalCreatureBaseClass):
    ...
    DEFAULT_STATS = {'hit_points': 39, 'min_level': 1, 'level': 1, 'STR': 8, 'DEX': 14, 'CON': 14, 'INT': 13, 'WIS': 14, 'CHAR': 11, 'armor_class': 14, 'alignment': 'lawful neutral Armor Class  14 (natural armor) Hit Points  39 (6d8 + 12) Speed  0 ft.', 'legendary': False, 'size': 'Medium', 'type': 'aberration', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['bite', 'eye_rays', 'confusion_ray', 'paralyzing_ray', 'fear_ray', 'wounding_ray', 'create_food_and_water']}
    ...
    def confusion_ray_attack(self) -> str:
    ...
    def paralyzing_ray_attack(self) -> str:
    ...
    def wounding_ray_attack(self) -> str:

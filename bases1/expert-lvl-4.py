# bases1/expert-lvl-4.py
"""
ExpertLvl4 creature class scraped from https://www.aidedd.org/dnd/monstres.php?vo=expert-lvl-4
"""
from creature_base import GlobalCreatureBaseClass


class ExpertLvl4(GlobalCreatureBaseClass):
    """
    Medium humanoid (any race) creature - ExpertLvl4
    Source: AiDeDd Monster Database (D&D 5e SRD)
    """
    
    # Valores por defecto extraídos del scraping
    DEFAULT_STATS = {'hit_points': 27, 'min_level': 1, 'level': 1, 'STR': 10, 'DEX': 17, 'CON': 12, 'INT': 13, 'WIS': 10, 'CHAR': 14, 'armor_class': 14, 'alignment': '- Armor Class  14 (studded leather) Hit Points  27 (5d8 + 5) Speed  30 ft. STR 10 (+0) DEX 17 (+3) CON 12 (+1) INT 13 (+1) WIS 10 (+0) CHA 14 (+2) Saving Throws  Dex +5 Skills  Acrobatics +5', 'legendary': False, 'size': 'Medium', 'type': 'humanoid (any race)', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['helpful', 'shortsword', 'dagger', 'shortbow']}
    ...
    def shortbow_attack(self) -> str:
        ...
        return 'Ranged Weapon Attack: +5 to hit, range 80/320 ft., one target. Hit: 7 (1d8 + 3) piercing damage.'

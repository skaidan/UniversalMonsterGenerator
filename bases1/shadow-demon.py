...
class ShadowDemon(GlobalCreatureBaseClass):
    ...
    Size: Medium, Type: fiend (Demon), chaotic evil
    ...
    def incorporeal_movement(self) -> str:
        """Incorporeal Movement: The demon can move through other creatures and objects as if they were difficult terrain. It takes 5..."""

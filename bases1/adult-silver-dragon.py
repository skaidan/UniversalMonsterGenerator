...
class AdultSilverDragon(GlobalCreatureBaseClass):
    """
    Huge dragon (Metallic) creature - AdultSilverDragon
    Source: AiDeDd Monster Database (D&D 5e SRD)
    """
    
    # Valores por defecto extraídos del scraping
    DEFAULT_STATS = {'hit_points': 243, 'min_level': 1, 'level': 1, 'STR': 27, 'DEX': 10, 'CON': 25, 'INT': 16, 'WIS': 13, 'CHAR': 21, 'armor_class': 19, 'alignment': 'lawful good Armor Class  19 (natural armor) Hit Points  243 (18d12 + 126) Speed  40 ft.', 'legendary': False, 'size': 'Huge', 'type': 'dragon (Metallic)', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['legendary_resistance_(3/day)', 'multiattack', 'bite', 'claw', 'tail', 'frightful_presence', 'breath_weapons_(recharge_5-6)', 'cold_breath', 'paralyzing_breath', 'change_shape']}
    ...
    def bite_attack(self) -> str:
        ...
        return 'Melee Weapon Attack: +13 to hit, reach 10 ft., one target. Hit: 19 (2d10 + 8) piercing damage.'

    def claw_attack(self) -> str:
        """Melee Weapon Attack: +13 to hit, reach 5 ft., one target. Hit: 15 (2d6 + 8) slashing damage."""
        return 'Melee Weapon Attack: +13 to hit, reach 5 ft., one target. Hit: 15 (2d6 + 8) slashing damage.'

    def tail_attack(self) -> str:
        """Melee Weapon Attack: +13 to hit, reach 15 ft., one target. Hit: 17 (2d8 + 8) bludgeoning damage."""
        return 'Melee Weapon Attack: +13 to hit, reach 15 ft., one target. Hit: 17 (2d8 + 8) bludgeoning damage.'
    ...
    def cold_breath_attack(self) -> str:
        ...
        return 'The dragon exhales an icy blast in a 60-foot cone. Each creature in that area must make a DC 20 Constitution saving throw, taking 58 (13d8) cold damage on a failed save, or half as much damage on a successful one.'
    ...
    def paralyzing_breath_attack(self) -> str:
        ...
        return 'The dragon exhales paralyzing gas in a 60-foot cone. Each creature in that area must succeed on a DC 20 Constitution saving throw or be paralyzed for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.'

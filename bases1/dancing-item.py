...
class DancingItem(GlobalCreatureBaseClass):
    ...
    DEFAULT_STATS = {'hit_points': 10, 'min_level': 1, 'level': 1, 'STR': 18, 'DEX': 14, 'CON': 16, 'INT': 4, 'WIS': 10, 'CHAR': 6, 'armor_class': 16, 'alignment': '- Armor Class  16 (natural armor) Hit Points  10 + five times your bard level Speed  30 ft.', 'legendary': False, 'size': 'Large', 'type': 'construct', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['immutable_form', 'force_empowered_slam']}
    ...
    def force_empowered_slam_attack(self) -> str:

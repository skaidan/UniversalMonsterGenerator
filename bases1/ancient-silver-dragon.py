...
class AncientSilverDragon(GlobalCreatureBaseClass):
    """
    Gargantuan dragon (Metallic) creature - AncientSilverDragon
    Source: AiDeDd Monster Database (D&D 5e SRD)
    """
    
    # Valores por defecto extraídos del scraping
    DEFAULT_STATS = {'hit_points': 487, 'min_level': 1, 'level': 1, 'STR': 30, 'DEX': 10, 'CON': 29, 'INT': 18, 'WIS': 15, 'CHAR': 23, 'armor_class': 22, 'alignment': 'lawful good Armor Class  22 (natural armor) Hit Points  487 (25d20 + 225) Speed  40 ft.', 'legendary': False, 'size': 'Gargantuan', 'type': 'dragon (Metallic)', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['legendary_resistance_(3/day)', 'multiattack', 'bite', 'claw', 'tail', 'frightful_presence', 'breath_weapons_(recharge_5-6)', 'cold_breath', 'paralyzing_breath', 'change_shape']}
    ...
    def cold_breath_attack(self) -> str:
        ...
        return 'The dragon exhales an icy blast in a 90-foot cone. Each creature in that area must make a DC 24 Constitution saving throw, taking 67 (15d8) cold damage on a failed save, or half as much damage on a successful one.'
    ...
    def paralyzing_breath_attack(self) -> str:
        ...
        return 'The dragon exhales paralyzing gas in a 90-foot cone. Each creature in that area must succeed on a DC 24 Constitution saving throw or be paralyzed for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.'

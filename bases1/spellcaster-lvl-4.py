# bases1/spellcaster-lvl-4.py
"""
SpellcasterLvl4 creature class scraped from https://www.aidedd.org/dnd/monstres.php?vo=spellcaster-lvl-4
"""
from creature_base import GlobalCreatureBaseClass


class SpellcasterLvl4(GlobalCreatureBaseClass):
    """
    Medium humanoid (any race) creature - SpellcasterLvl4
    Source: AiDeDd Monster Database (D&D 5e SRD)
    """
    
    # Valores por defecto extraídos del scraping
    DEFAULT_STATS = {'hit_points': 22, 'min_level': 1, 'level': 1, 'STR': 10, 'DEX': 12, 'CON': 10, 'INT': 15, 'WIS': 16, 'CHAR': 13, 'armor_class': 12, 'alignment': '- Armor Class  12 (leather armor) Hit Points  22 (5d8) Speed  30 ft. STR 10 (+0) DEX 12 (+1) CON 10 (+0) INT 15 (+2) WIS 16 (+3) CHA 13 (+1) Saving Throws  Wis +5 Skills  Arcana +4', 'legendary': False, 'size': 'Medium', 'type': 'humanoid (any race)', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['magical_role', 'quatersatff']}

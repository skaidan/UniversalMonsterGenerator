...
class BrassDragonWyrmling(GlobalCreatureBaseClass):
    ...
    def bite(self) -> str:
        ...
        return "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (1d10 + 2) piercing damage.Breath Weapons (Recharge 5-6). The dragon uses one of the following breath weapons.Fire Breath. The dragon ex"
    def bite(self) -> str:
        """Bite: Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (1d10 + 2) piercing damage.Breath We..."""
        return "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (1d10 + 2) piercing damage.Breath Weapons (Recharge 5-6). The dragon uses one of the following breath weapons.Fire Breath. The dragon ex"

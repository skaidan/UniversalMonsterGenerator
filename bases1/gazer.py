...
class Gazer(GlobalCreatureBaseClass):
    ...
    DEFAULT_STATS = {'hit_points': 13, 'min_level': 1, 'level': 1, 'STR': 3, 'DEX': 17, 'CON': 14, 'INT': 3, 'WIS': 10, 'CHAR': 7, 'armor_class': 13, 'alignment': 'typically Neutral Evil Armor Class  13 Hit Points  13 (3d4 + 6) Speed  0 ft.', 'legendary': False, 'size': 'Tiny', 'type': 'Aberration (Beholder)', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['mimicry', 'bite', 'eye_rays', 'ability_1__dazing_ray', 'ability_2__fear_ray', 'ability_3__frost_ray', 'ability_4__telekinetic_ray']}
    ...
    def attack_1_dazing_ray_attack(self) -> str:
    ...
    def attack_3_frost_ray_attack(self) -> str:
    ...
    def attack_4_telekinetic_ray_attack(self) -> str:

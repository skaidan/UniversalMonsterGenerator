...
class BeholderZombie(GlobalCreatureBaseClass):
    ...
    DEFAULT_STATS = {'hit_points': 93, 'min_level': 1, 'level': 1, 'STR': 10, 'DEX': 8, 'CON': 16, 'INT': 3, 'WIS': 8, 'CHAR': 5, 'armor_class': 15, 'alignment': 'neutral evil Armor Class  15 (natural armor) Hit Points  93 (11d10 + 33) Speed  0 ft.', 'legendary': False, 'size': 'Large', 'type': 'undead', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['undead_fortitude', 'bite', 'eye_ray', 'ability_1__paralyzing_ray', 'ability_2__fear_ray', 'ability_3__enervation_ray', 'ability_4__disintegration_ray']}
    ...
    def attack_1_paralyzing_ray_attack(self) -> str:
    ...
    def attack_2_fear_ray_attack(self) -> str:
    ...
    def attack_3_enervation_ray_attack(self) -> str:
    ...
    def attack_4_disintegration_ray_attack(self) -> str:

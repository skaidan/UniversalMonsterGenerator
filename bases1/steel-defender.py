...
class SteelDefender(GlobalCreatureBaseClass):
    ...
    DEFAULT_STATS = {'hit_points': 10, 'min_level': 1, 'level': 1, 'STR': 14, 'DEX': 12, 'CON': 14, 'INT': 4, 'WIS': 10, 'CHAR': 6, 'armor_class': 15, 'alignment': '- Armor Class  15 (natural armor) Hit Points  2 + your Intelligence modifier + five times your artificer level (the defender has a number of Hit Dice [d8s] equal to your artificer level) Speed  40 ft. STR 14 (+2) DEX 12 (+1) CON 14 (+2) INT 4 (-3) WIS 10 (+0) CHA 6 (-2) Saving Throws  Dex +1 plus PB', 'legendary': False, 'size': 'Medium', 'type': 'construct', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['vigilant', 'force_empowered_rend', 'repair_(3/day)']}
    ...
    def force_empowered_rend_attack(self) -> str:

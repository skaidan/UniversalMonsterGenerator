...
class WarriorLvl2(GlobalCreatureBaseClass):
    """
    Medium humanoid (any race) creature - WarriorLvl2
    Source: AiDeDd Monster Database (D&D 5e SRD)
    """
    
    # Valores por defecto extraídos del scraping
    DEFAULT_STATS = {'hit_points': 19, 'min_level': 1, 'level': 1, 'STR': 15, 'DEX': 13, 'CON': 14, 'INT': 10, 'WIS': 12, 'CHAR': 10, 'armor_class': 16, 'alignment': '- Armor Class  16 (chain shirt', 'legendary': False, 'size': 'Medium', 'type': 'humanoid (any race)', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['martial_role', 'longsword', 'longbow']}

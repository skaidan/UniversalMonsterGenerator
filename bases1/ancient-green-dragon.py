# bases1/ancient-green-dragon.py
"""
AncientGreenDragon creature class scraped from https://www.aidedd.org/dnd/monstres.php?vo=ancient-green-dragon
"""
...
class AncientGreenDragon(GlobalCreatureBaseClass):
    ...
    def poison_breath_attack(self) -> str:

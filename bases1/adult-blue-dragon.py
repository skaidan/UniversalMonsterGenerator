...
class AdultBlueDragon(GlobalCreatureBaseClass):
    ...
    def bite_attack(self) -> str:
        ...
        return 'Melee Weapon Attack: +12 to hit, reach 10 ft., one target. Hit: 18 (2d10 + 7) piercing damage plus 5 (1d10) lightning damage.'

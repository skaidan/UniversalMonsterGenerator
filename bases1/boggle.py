...
class Boggle(GlobalCreatureBaseClass):
    ...
    DEFAULT_STATS = {'hit_points': 18, 'min_level': 1, 'level': 1, 'STR': 8, 'DEX': 18, 'CON': 13, 'INT': 6, 'WIS': 12, 'CHAR': 7, 'armor_class': 14, 'alignment': 'typically Chaotic Neutral Armor Class  14 Hit Points  18 (4d6 + 4) Speed  30 ft.', 'legendary': False, 'size': 'Small', 'type': 'Fey', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['pummel', 'oil_puddle', 'slippery_oil', 'sticky_oil']}
    ...
    def slippery_oil_attack(self) -> str:
    ...
    def sticky_oil_attack(self) -> str:

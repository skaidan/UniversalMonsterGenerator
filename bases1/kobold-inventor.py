...
class KoboldInventor(GlobalCreatureBaseClass):
    ...
    DEFAULT_STATS = {'hit_points': 13, 'min_level': 1, 'level': 1, 'STR': 7, 'DEX': 15, 'CON': 12, 'INT': 8, 'WIS': 7, 'CHAR': 8, 'armor_class': 12, 'alignment': 'any alignment Armor Class  12 Hit Points  13 (3d6 + 3) Speed  30 ft. STR 7 (-2) DEX 15 (+2) CON 12 (+1) INT 8 (-1) WIS 7 (-2) CHA 8 (-1) Senses  darkvision 60 ft.', 'legendary': False, 'size': 'Small', 'type': 'Humanoid', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['pack_tactics', 'dagger', 'sling', 'weapon_invention', 'ability_1__acid', 'ability_2__alchemists_fire', 'ability_3__basket_of_centipedes', 'ability_4__green_slime_pot', 'ability_5__rot_grub_pot', 'ability_6__scorpion_on_a_stick', 'ability_7__skunk_in_a_cage', 'ability_8__wasp_nest_in_a_bag']}
    ...
    def attack_1_acid_attack(self) -> str:
    ...
    def attack_2_alchemists_fire_attack(self) -> str:
    ...
    def attack_3_basket_of_centipedes_attack(self) -> str:
    ...
    def attack_4_green_slime_pot_attack(self) -> str:
    ...
    def attack_5_rot_grub_pot_attack(self) -> str:
    ...
    def attack_6_scorpion_on_a_stick_attack(self) -> str:
    ...
    def attack_7_skunk_in_a_cage_attack(self) -> str:
    ...
    def attack_8_wasp_nest_in_a_bag_attack(self) -> str:

# bases1/warrior-lvl-5.py
"""
WarriorLvl5 creature class scraped from https://www.aidedd.org/dnd/monstres.php?vo=warrior-lvl-5
"""
from creature_base import GlobalCreatureBaseClass


class WarriorLvl5(GlobalCreatureBaseClass):
    """
    Medium humanoid (any race) creature - WarriorLvl5
    Source: AiDeDd Monster Database (D&D 5e SRD)
    """
    
    # Valores por defecto extraídos del scraping
    DEFAULT_STATS = {'hit_points': 39, 'min_level': 1, 'level': 1, 'STR': 17, 'DEX': 13, 'CON': 14, 'INT': 10, 'WIS': 12, 'CHAR': 10, 'armor_class': 16, 'alignment': '- Armor Class  16 (chain shirt', 'legendary': False, 'size': 'Medium', 'type': 'humanoid (any race)', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['martial_role', 'longsword', 'longbow']}
    ...
    def longbow_attack(self) -> str:
        ...
        return 'Ranged Weapon Attack: +4 to hit, range 150/600 ft., one target. Hit: 5 (1d8 + 1) piercing damage.'

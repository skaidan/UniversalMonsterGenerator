# bases1/expert-lvl-2.py
"""
ExpertLvl2 creature class scraped from https://www.aidedd.org/dnd/monstres.php?vo=expert-lvl-2
"""
from creature_base import GlobalCreatureBaseClass


class ExpertLvl2(GlobalCreatureBaseClass):
    """
    Medium humanoid (any race) creature - ExpertLvl2
    Source: AiDeDd Monster Database (D&D 5e SRD)
    """
    
    # Valores por defecto extraídos del scraping
    DEFAULT_STATS = {'hit_points': 16, 'min_level': 1, 'level': 1, 'STR': 10, 'DEX': 15, 'CON': 12, 'INT': 13, 'WIS': 10, 'CHAR': 14, 'armor_class': 14, 'alignment': '- Armor Class  14 (studded leather) Hit Points  16 (3d8 + 3) Speed  30 ft. STR 10 (+0) DEX 15 (+2) CON 12 (+1) INT 13 (+1) WIS 10 (+0) CHA 14 (+2) Saving Throws  Dex +4 Skills  Acrobatics +4', 'legendary': False, 'size': 'Medium', 'type': 'humanoid (any race)', 'hit_points_up': [1, 1, 1], 'STR_up': [1, 1, 0], 'DEX_up': [0, 1, 0], 'CON_up': [0, 0, 1], 'INT_up': [1, 0, 0], 'WIS_up': [0, 0, 1], 'CHAR_up': [0, 0, 0], 'abilities': ['helpful', 'shortsword', 'dagger', 'shortbow']}
